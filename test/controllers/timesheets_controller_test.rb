...
class TimesheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post timesheets_url, params: { timesheet: { billing_rate: @timesheet.billing_rate, company_id: @timesheet.company_id, firstname: @timesheet.firstname, lastname: @timesheet.lastname } }
    end
  ...
  test "should update timesheet" do
    patch timesheet_url(@timesheet), params: { timesheet: { billing_rate: @timesheet.billing_rate, company_id: @timesheet.company_id, firstname: @timesheet.firstname, lastname: @timesheet.lastname } }
